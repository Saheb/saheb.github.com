...
Yes, these temporal rewards are managed via discounted rewards, bellman equations solve it perfectly. Future rewards are given less weight in comparison to immediate rewards. And that weight is a function of time/steps, reduces further you go. Overall value at a given state if the sum of immediate reward and discounted future value.
